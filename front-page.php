    ...
    <div class="full-width-split__one">
      <div class="full-width-split__inner">
        <h2 class="headline headline--small-plus t-center">Upcoming Events</h2>
           ...
           <?php    //this handles the order in wich events are displayed. The closest date appears first
             $today = date("Ymd");
             $homepageEvents = new WP_Query(array(
               "posts_per_page" => 2,   //-1 means wp will return every post that matches the conditions below
               "post_type" => "event",
